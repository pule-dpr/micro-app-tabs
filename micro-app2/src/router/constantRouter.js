const router = [
	{
		path: '/specificCase/index',
		name: 'specificCase',
		meta: {
			title: '菜单案例',
			keepAlive: true
		},
		component: () => import(/* webpackChunkName: "demand" */ '@/views/specificCase/index.vue')
	},
	{
		path: '/keepAliveCase/index',
		name: 'keepAliveCase',
		meta: {
			title: '保活案例',
			keepAlive: true
		},
		component: () => import(/* webpackChunkName: "task" */ '@/views/keepAliveCase/index.vue')
	},
	{
